    ...
    <main>
        <div class="card login mt-3 p-3">
            <div class="card-body">
                ...
                <form id="editar" class="row col-12 justify-content-center" enctype="multipart/form-data">
                    <p class="text-center">Esta es la información actual del producto, edite los datos a convenir</p>
                    <div class="form-group col-sm-12 col-md-12 col-12 m-2">
                        <label for="codigo">Codigo del Producto: </label>
                        <input type="number" class="form-control" id="codigo" name="codigo" placeholder="Codigo..." readonly>
                    </div>  
                    <div class="form-group col-sm-12 col-md-12 col-12 m-2">
